...
const navigation = [
  ...
  { name: 'Trainees', href: '/coordinator/trainees', icon: GraduationCap },
  { name: 'Assign Trainees', href: '/coordinator/assign', icon: Users },
  { name: 'Attendance', href: '/coordinator/attendance', icon: Clock },
  { name: 'Tasks', href: '/coordinator/tasks', icon: CheckCircle },
  { name: 'Documents', href: '/coordinator/documents', icon: FileText },
  { name: 'Placement Requests', href: '/coordinator/placements', icon: Handshake },
