...
const navigation = [
  ...
  { name: 'Trainees', href: '/coordinator/trainees', icon: GraduationCapIcon },
  { name: 'Assign Trainees', href: '/coordinator/assign', icon: UsersIcon },
  { name: 'Attendance', href: '/coordinator/attendance', icon: ClockIcon },
  { name: 'Tasks', href: '/coordinator/tasks', icon: CheckCircleIcon },
  { name: 'Documents', href: '/coordinator/documents', icon: DocumentTextIcon },
  { name: 'Placement Requests', href: '/coordinator/placements', icon: HandshakeIcon },
  { name: 'Verify Companies', href: '/coordinator/companies', icon: BuildingOfficeIcon },
