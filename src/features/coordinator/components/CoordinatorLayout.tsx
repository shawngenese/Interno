...
const navigation = [
  { name: 'Dashboard', href: '/coordinator', icon: HomeIcon },
  { name: 'Trainees', href: '/coordinator/trainees', icon: UserCircleIcon },
  { name: 'Assign Trainees', href: '/coordinator/assign', icon: UsersIcon },
  { name: 'Attendance', href: '/coordinator/attendance', icon: CalendarIcon },
  { name: 'Tasks', href: '/coordinator/tasks', icon: CheckCircleIcon },
  { name: 'Documents', href: '/coordinator/documents', icon: DocumentIcon },
  { name: 'Placement Requests', href: '/coordinator/placements', icon: HandshakeIcon },
  { name: 'Verify Companies', href: '/coordinator/companies', icon: BuildingCheckIcon },
  { name: 'Invite Supervisors', href: '/coordinator/invite-supervisors', icon: UserPlusIcon },
  { name: 'Evaluations', href: '/coordinator/evaluations', icon: ClipboardCheckIcon },
  { name: 'Announcements', href: '/coordinator/announcements', icon: BellIcon },
];
...
function BuildingCheckIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-4 border-b border-[#D5D5D5] dark:border-[#3A3A3A]">
            <h1 className="text-xl font-bold text-[#121212] dark:text-white">Interno Coordinator</h1>
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-semibold text-[#121212] dark:text-white">
                {navigation.find(n => location.pathname === n.href || (n.href !== '/coordinator' && location.pathname.startsWith(n.href)))?.name || 'Coordinator'}
              </h2>
            </div>
          </div>
        </header>
